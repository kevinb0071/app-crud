            ...
            <div class="col-md-4">
                <form action="{{ route('product.update', ['product' => $product]) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ $product->name }}" placeholder="Name" id="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="qty">Quantity:</label><br>
                        <input type="text" class="form-control" name="qty" value="{{ $product->qty }}" placeholder="Quantity" id="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="price">Price:</label><br>
                        <input type="text" class="form-control" name="price" value="{{ $product->price }}" placeholder="Price" id="">
                    </div>
                    <div class="mb-3">
